...
def start_training(char_name: str, char_class: str) -> str:
    """
    Начало тренировки, выбираем действие.
    При некорректном написании удара ломается.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбираем класс.При некорректном написании класса все плохо."""
    approve_choice: str = str(None)
    char_class: str = str(None)
